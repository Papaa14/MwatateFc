                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('specialization') is-invalid @enderror" id="specialization" name="specialization" required>
                                ...
                                <option value="Fitness" {{ old('specialization') == 'Fitness' ? 'selected' : '' }}>Fitness</option>
                                <option value="Yoga" {{ old('specialization') == 'Yoga' ? 'selected' : '' }}>Yoga</option>
                                <option value="Nutrition" {{ old('specialization') == 'Nutrition' ? 'selected' : '' }}>Nutrition</option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('certifications') is-invalid @enderror" id="certifications" name="certifications" value="{{ old('certifications') }}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('years_experience') is-invalid @enderror" id="years_experience" name="years_experience" value="{{ old('years_experience', 0) }}" min="0">
